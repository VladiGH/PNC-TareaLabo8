...
public class ClienteDAOImpl implements ClienteDAO {
	...
	public int insertClienteAutoId(Cliente c) {
		...
		//TODO: Si el id ya existe solo lo actualiza
	}

	//TODO: La query para el update
	...
	public int ejecutarProcedimientoJdbc(Integer cliente, Boolean estado) {
		...
		/*
		 * se registran los params en el objeto corresp
		 * param de entrada -> new SqlParameter
		 * param de salida -> new SqlOutParameter
		 * */
		...
		//Mapa con los nombres de los params y sus valores
